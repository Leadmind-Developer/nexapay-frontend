    ...
    <section className="relative overflow-hidden py-24 min-h-[600px]" style={{ paddingTop: `${headerHeight}px` }}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-12 lg:px-16 text-center">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl font-extrabold mb-6 leading-tight text-center text-yellow-300 inline-flex items-center gap-1 justify-center"
        >
        ...
        <motion.p
          ...
          className="text-lg text-indigo-900 mb-10 leading-relaxed max-w-3xl mx-auto"
        >
        ...
        >
          <a
            ...
            target="_blank"
            className="bg-green-500 px-8 py-3 rounded-lg font-semibold hover:bg-green-600 transition flex items-center gap-2 text-white text-sm sm:text-base"
          >
            WhatsApp
          </a>
          <a
            ...
            target="_blank"
            className="bg-blue-500 px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 transition flex items-center gap-2 text-white text-sm sm:text-base"
          >
            Telegram
          </a>
          <a
            ...
            target="_blank"
            className="bg-black px-8 py-3 rounded-lg font-semibold hover:bg-gray-800 transition flex items-center gap-2 text-white text-sm sm:text-base"
          >
          ...
          <a
            ...
            target="_blank"
            className="bg-black px-4 py-3 rounded-lg font-semibold hover:bg-gray-900 transition flex items-center gap-2 text-white text-sm sm:text-base"
          >
