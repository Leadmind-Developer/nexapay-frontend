...
export default function Steps() {
  return (
    <section className="py-16 sm:py-20 bg-gradient-to-b from-white to-indigo-50 text-center">
      <motion.h2
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="text-2xl sm:text-3xl font-bold mb-8 sm:mb-12 text-gray-900"
      >
        How It Works
      </motion.h2>

      <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-8 max-w-6xl mx-auto px-6 sm:px-4">
        {steps.map((step, idx) => (
          <motion.div
            key={idx}
            ...
            className="relative bg-white p-6 sm:p-8 rounded-2xl shadow-md hover:shadow-xl transition w-full sm:w-64 md:w-60 flex flex-col items-center"
          >
            ...
            <h3 className="mt-6 text-lg sm:text-xl font-semibold mb-2 text-gray-900">{step.title}</h3>
