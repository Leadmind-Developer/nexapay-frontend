...
export default function CTA() {
  return (
    <section
      className="relative overflow-hidden py-16 sm:py-20 bg-gradient-to-r from-indigo-50 via-purple-50 to-blue-50 text-indigo-900 text-center"
      role="region"
      aria-labelledby="cta-heading"
    >
      {/* Background pattern */}
      <div className="absolute inset-0 opacity-10 bg-[url('/pattern.svg')] bg-repeat bg-center" />
      ...
      >
        <h2 id="cta-heading" className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-6 sm:mb-8 leading-snug">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
          <motion.a
            ...
            aria-label="Chat with NexaPay on WhatsApp"
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Chat with NexaPay on Telegram"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          ...
          <motion.a
            href="/register"
            aria-label="Create a NexaPay account"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
