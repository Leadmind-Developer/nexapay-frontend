...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden text-left py-24 min-h-[600px]">
      {/* Background image on the right, shifted down */}
      <div
        className="absolute inset-0 bg-contain bg-right bg-no-repeat"
        style={{
          top: "80px", // push down
          bottom: 0,
          width: "100%", // cover right half only
      ...
      <div className="relative z-10 max-w-6xl px-12 lg:px-16">
        ...
        {/* Action buttons including WhatsApp, Telegram, iOS, Google Play */}
        <motion.div
        ...
        >
          <a
            ...
            target="_blank"
            className="bg-green-500 px-8 py-3 rounded-lg font-semibold hover:bg-green-600 transition flex items-center gap-2"
          >
            WhatsApp
          </a>
          <a
            ...
            target="_blank"
            className="bg-blue-500 px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 transition flex items-center gap-2"
          >
            Telegram
          </a>
          <a
