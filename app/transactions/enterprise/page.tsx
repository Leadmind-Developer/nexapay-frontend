// ./app/transactions/enterprise/page.tsx
import EnterpriseBulkForm from "@/components/transactions/EnterpriseBulkForm";
import SEO from "@/components/SEO";
import { Metadata } from "next";

// ✅ Keep this a Server Component to allow "metadata" export
...
export default function EnterpriseBulkPage() {
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <EnterpriseBulkForm /> {/* Client Component inside a Server Component */}
    </div>
  );
}
